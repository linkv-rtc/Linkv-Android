...
import com.linkv.rtc.internal.src.voiceengine.WebRtcAudioEffects;
...
public class AudioRecorder {
    ...
    private
    WebRtcAudioEffects effects = WebRtcAudioEffects.create();
    ...
    private WebRtcAudioRecordSamplesReadyCallback audioSamplesReadyCallback;

    public static void setErrorCallback(WebRtcAudioRecordErrorCallback errorCallback) {
        Logging.d(TAG, "Set error callback");
        AudioRecorder.errorCallback = errorCallback;
    }
    ...
    public void setOnAudioSamplesReady(WebRtcAudioRecordSamplesReadyCallback callback) {
...
//        nativeCacheDirectBufferAddress(byteBuffer, nativeAudioRecord);
        ...
        try {
            Logging.d(TAG, "initRecording  audioSource=" + audioSource);
...
//        WebRtcAudioUtils.logAudioState(TAG);
     ...
     * AudioRecorder.WebRtcAudioRecordSamplesReadyCallback}
     */
...
//                        nativeDataIsRecorded(bytesRead, nativeAudioRecord);
                        // TODO: read the recorded audio buffer
                    }
